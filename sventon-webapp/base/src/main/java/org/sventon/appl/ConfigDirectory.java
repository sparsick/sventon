...
public class ConfigDirectory implements ServletContextAware {
  ...
  /**
   * Servlet context path where the application is deployed.
   * Default set to 'svn'.
   */
  private String contextPath = "svn";
  ...
  /**
   * Constructor for testing. Without this constructor Easy Mock cannot create mokcs of this class. Don't use it in production code.
   */
  ConfigDirectory(){
      this.exportDirectoryName = "";
      this.repositoriesDirectoryName ="";
  }
  ...
  public void setServletContext(final ServletContext servletContext) {
    ...
    try {
      ...
      logger.info("ServletContext.getContextPath() is not supported by your servlet container. Defaulting to [svn].");
    }
  ...
  /**
   * @return The context path where the application has been deployed.
   */
   ...
   * @return Factory
   */
  public ConfigDirectoryFactory createConfigDirectoryFactory() {
    return new ConfigDirectoryFactory(repositoriesDirectory);
  }
